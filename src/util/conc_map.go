...
type ConcMap []*ConcurrentMapShared
...
//Reviles ConcMap "private" variables to json marshal.
...
// func (m *ConcMap) UnmarshalJSON(b []byte) (err error) {
